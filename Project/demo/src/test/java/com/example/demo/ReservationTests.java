...
public class ReservationTests {
    MockReservationDataHelper mrdh = new MockReservationDataHelper();
    MockReservationAdministration mra = new MockReservationAdministration(mrdh);
    MockReservationController mrc = new MockReservationController(mra);
    @Test
     void GetReservationRequest()
    {
       UserDTO client = ClientDTO.builder()
        ...
        ReservationRequestDTO reservationRequest = ReservationRequestDTO.builder()
                ...
                .approved(false)
                .build();
        Assertions.assertEquals(reservationRequest, mrc.GetReservationRequest(1));
    }
    @Test
     void GetTables()
    {
        TableItemDTO table = TableItemDTO.builder()
                ...
                .location("Outside")
                        .build();
        Assertions.assertEquals(table, mrc.GetTables().get(1));
    }
    @Test
     void GetTable()
    {
        TableItemDTO table = TableItemDTO.builder()
                ...
                .location("Outside")
                .build();
        Assertions.assertEquals(table, mrc.GetTable(1));
    }
    @Test
     void GetUnapprovedReservationRequests() {
        ...
        ReservationRequestDTO reservationRequest = ReservationRequestDTO.builder()
                ...
                .approved(false)
                        .build();
        Assertions.assertEquals(reservationRequest, mrc.GetUnapprovedReservationRequests().get(1));
    }
    @Test
     void GetApprovedReservationRequests() {
        ...
        ReservationRequestDTO reservationRequest = ReservationRequestDTO.builder()
                ...
                .approved(true)
                .build();
        Assertions.assertEquals(reservationRequest, mrc.GetApprovedReservationRequests().get(0));
    }
}
