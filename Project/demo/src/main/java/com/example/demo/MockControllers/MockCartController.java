...
import com.example.demo.Administrations.CartAdministration;
...
public class MockCartController {
    ...
    @Autowired
    public MockCartController(MockCartAdministration mockCartAdministration) {
        ...
        orderedMeals.add(new OrderedMealDTO(1, users.get(1), meals.get(0), addings2, 6.99));
