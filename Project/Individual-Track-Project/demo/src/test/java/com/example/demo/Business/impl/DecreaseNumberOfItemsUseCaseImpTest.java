...
class DecreaseNumberOfItemsUseCaseImpTest {
    @Mock
    ...
    @InjectMocks
    private DecreaseNumberOfItemsUseCaseImp decreaseNumberOfItemsUseCase;
    @Test
    void decreaseNumber() {
        ...
        decreaseNumberOfItemsUseCase.decrease(cartItemList.get(0).getId());
        when(cartItemRepository.findById(cartItemList.get(0).getId())).thenReturn(Optional.of(cartItem));
        ...
        assertEquals(3, returnCartItem2.getNumberOfItems());
    }
}